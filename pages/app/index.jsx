...
const Index = () => {
  ...
  return (
    <Panel>
        <h1 className="text-3xl text-blue-600 mb-2">Actions</h1>
        <div className="flex flex-wrap sm:flex-no-wrap items-center justify-between w-full gap-3 flex-col md:flex-row">
            <div className="w-full md:w-1/3 h-64 shadow bg-white dark:bg-gray-800 p-4 flex flex-col items-center justify-between ">
              <h1 className='text-4xl font-mono font-bold text-center'>Add New Workout Routines</h1>
            ...
            <div className="w-full md:w-1/3 h-64 shadow bg-white dark:bg-gray-800 p-4 flex flex-col items-center justify-between ">
              <h1 className='text-4xl font-mono font-bold text-center'>View Your Workout Routines</h1>
